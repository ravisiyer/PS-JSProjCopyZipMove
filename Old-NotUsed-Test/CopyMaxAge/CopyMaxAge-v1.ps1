...
Write-Host "robocopy '$InputFolder' '$OutputFolder' /S /MAXAGE:$MaxAge", `n
...
#robocopy $InputFolder $OutputFolder /E /XD node_modules .next build .gradle
robocopy $InputFolder $OutputFolder /S /MAXAGE:$MaxAge
