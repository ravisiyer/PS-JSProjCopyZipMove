...
#
param ($Path = $pwd, $MaxAge="1", $ExcludeFolders="", $UniqueParentFolder="")
...
function Usage {
  ...
  Write-Host Usage: $CmdName [Path MaxAge ExcludeFolders UniqueParentFolder]`n
