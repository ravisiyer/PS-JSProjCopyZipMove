...
# The script also strips trailing backslash from Source-Folder-Name if present.
...
function Usage {
  ...
  Write-Host "Usage: If Output folder name is not specified, it is generated by concatenating" $OutputSuffixDefault "to Source-Folder-Name."
