...
function Usage {
  param ($cmdName)
  Write-Host "CopyWoXF + ZipFldrWDtTm + Optionally Move OutputZipFile to BackupFolder + Optionally MoveToMDLWDtTm (for CopyWoXF OutputFolder)"`n
  ...
  Write-Host "User is interactively given the option to skip each of the two steps of 'Move OutputZipFile to BackupFolder' and 'MoveToMDLWDtTm'."
