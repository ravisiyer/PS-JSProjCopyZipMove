...
Write-Output "CopyXFProj: Copy all source files and folders of a project of specified type or default type (currently 'Others')."
...
Write-Output "PrMaxAgeMFCpXF7ZipMv: Wrapper around CpXFZipMv script tailored for backup copy of multiple folders with user prompt for MaxAge (including - for ignore) and using 7zip."
Write-Output "CpXFProj7ZipMv: Wrapper around PrMaxAgeMFCpXF7ZipMv for a single project of specified type or default type (currently 'Others')."
Write-Output "CpXFRNProj7ZipMv: Wrapper around CpXFProj7ZipMv tailored for a React Native project."
Write-Output "CpXFAndroidProj7ZipMv: Wrapper around CpXFProj7ZipMv tailored for an Android project."
Write-Output "CpXFDotNetProj7ZipMv: Wrapper around CpXFProj7ZipMv tailored for a DotNet project."
